...
async function convertFiles() {
    ...
    try {
        ...
        for (const file of filesToConvert) {
            ...
            const jpgBlob = await convertToJpg(imgElement);
            convertedFiles.push(jpgBlob);
        }
...
function convertToJpg(imgElement) {
...
function createSingleDownloadLink(blob) {
    ...
    downloadButton.download = `${originalFilename}_prepphint.com.jpg`;
}
...
function createDownloadLink(blobs) {
    ...
    blobs.forEach((blob, index) => {
        ...
        zip.file(`${originalFileName}_prepphint.com.jpg`, blob);
    });
